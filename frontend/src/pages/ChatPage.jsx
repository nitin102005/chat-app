    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <div className="relative group">
          <UserIcon className="absolute left-3 top-3.5 w-5 h-5 text-gray-400 group-focus-within:text-gray-700 transition" />
    ...
    <div className="mt-6 text-center text-sm text-gray-500 font-[DM_Sans]">
      ...
      >
        Login
            ...
            {/* RIGHT SIDE */}
            <div className="hidden md:flex md:w-1/2 items-center justify-center bg-linear-to-b from-black via-zinc-900 to-black p-8 relative">
              ...
              <div className="relative text-center">
                <img
                  src="/signup.png"
                  alt="Illustration"
                  className="w-[80%] mx-auto drop-shadow-[0_10px_30px_rgba(255,255,255,0.1)] hover:scale-105 transition-transform duration-500"
                />
                ...
                <div className="mt-4 flex justify-center gap-3">
                  {["Free", "Easy Setup", "Private"].map((item, i) => (
                    <span
                      key={i}
