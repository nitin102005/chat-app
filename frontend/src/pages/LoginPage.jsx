...
function LoginPage() {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-linear-to-br from-black via-zinc-900 to-black p-4">
  ...
  <div className="w-full max-w-md">
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-lg bg-white border border-gray-300 text-gray-900 placeholder-gray-400 outline-none focus:ring-2 focus:ring-black/20 focus:border-black transition-all"
          />
        </div>
      </div>
      ...
      <button
        ...
        className="w-full py-3 rounded-lg bg-black text-white font-semibold tracking-wide hover:bg-black/90 transition-all active:scale-[0.98] flex items-center justify-center shadow-md"
      >
        {isLoggingIn ? (
    ...
    />
                ...
                <div className="mt-4 flex justify-center gap-3">
                  {["Fast", "Secure", "Reliable"].map((item, i) => (
                    <span
                      key={i}
                      className="px-4 py-1 text-xs rounded-full bg-white/10 text-white border border-white/20 backdrop-blur-md hover:bg-white/20 transition"
                    >
                      {item}
                    </span>
                  ))}
